...
make test INTERACTIVE='' LD_LIBRARY_PATH-${PREFIX}/lib IDRIS2_BOOT=${PREFIX}/bin/idris2sh SCHEME=${SCHEME} IDRIS2_PATH=${IDRIS2_BOOT_PATH} IDRIS2_LIBS=${PREFIX}/idris2-0.2.0/lib
