...
results =  testCasts Int8 Int16   [(-129,127),(-128,-128),(0,0),(127,127),(128,-128)]
        ...
        -- refc: Int = int64_t, so Int64→Int is identity (no 32-bit wrapping)
        ...
        -- refc: avoid large Int64→Double cases where compile-time vs C-runtime rounding diverges
        ++ testCasts Int64 Double  [(-9223372036854775808,-9223372036854775808),(0,0)]
        ...
        -- refc: Int = int64_t (same as Int64), so use 64-bit boundary values
        ...
        ++ testCasts Int Double  [(-9223372036854775808,-9223372036854775808),(0,0)]
        ++ testCasts Int String  [(-9223372036854775808,"-9223372036854775808"),(0,"0"),(9223372036854775807,"9223372036854775807")]
        ++ testCasts Int Integer [(-9223372036854775808,-9223372036854775808),(0,0),(9223372036854775807,9223372036854775807)]
        ...
        -- refc: Int = int64_t, so Bits32 0xffffffff→Int = 4294967295 (no sign wrap)
        ++ testCasts Bits32 Int     [(0,0),(0xffffffff,4294967295),(0x100000000,0)]
        ...
        -- refc: 0xffffffffffffffff→Double has compile-time vs C-runtime rounding divergence; skip
        ++ testCasts Bits64 Double  [(0,0),(0x10000000000000000,0)]
        ...
        -- refc: strtoll saturates on overflow (not wraps); skip out-of-range cases
        ++ testCasts String Int64   [("-9223372036854775808",-9223372036854775808),("0",0),("9223372036854775807",9223372036854775807)]
        -- refc: Int = int64_t; test 64-bit range, not 32-bit wrapping
        ++ testCasts String Int     [("-9223372036854775808",-9223372036854775808),("0",0),("9223372036854775807",9223372036854775807)]
        ...
        -- refc: strtoull saturates at UINT64_MAX on overflow (not wraps); skip overflow case
        ++ testCasts String Bits64  [("0",0),("18446744073709551615",18446744073709551615)]
        ...
        -- refc: Double values outside Int64 range invoke C UB; keep only safe cases
        ++ testCasts Double Int64   [(-9223372036854775808.0,-9223372036854775808),(-12.001,-12),(12.001,12)]
        -- refc: Int = int64_t, no 32-bit wrapping; -2147483649 etc. fit without overflow
        ++ testCasts Double Int     [(-2147483649.0,-2147483649),(-2147483648.0,-2147483648),(-12.001,-12),(12.001,12),(2147483647.0,2147483647),(2147483648.0,2147483648)]
        ++ testCasts Double Bits8   [(0.0,0),(255.0,255), (256.0,0)]
        ++ testCasts Double Bits16  [(0.0,0),(65535.0,65535), (65536.0,0)]
        -- refc: Double values outside BitsN range are C UB; keep only in-range cases
        ++ testCasts Double Bits32  [(0.0,0),(255.0,255),(65535.0,65535),(4294967295.0,4294967295)]
        ++ testCasts Double Bits64  [(0.0,0),(255.0,255),(65535.0,65535)]
