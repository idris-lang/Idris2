...
results =
  ...
  ++ testOp Int32 "shl" prim__shl_Int32
       [(0,31,0),(1,1,2),(1,4,16),(1,31,-0x80000000),(1,32,0),(-1,31,-0x80000000)]
  ++ testOp Int32 "shr" prim__shr_Int32
       [(0,31,0),(1,1,0),(-0x80000000,1,-0x40000000),(0x7fffffff,3,0x0fffffff),(-0x80000000,32,-1),(-1,3,-1)]
  ...
  ++ testOp Bits32 "shl" prim__shl_Bits32
       [(0,31,0),(1,1,2),(1,4,16),(1,31,0x80000000),(1,32,0),(0xffffffff,31,0x80000000)]
  ++ testOp Bits32 "shr" prim__shr_Bits32
       [(0,31,0),(1,1,0),(0xffffffff,1,0x7fffffff),(0x7fffffff,3,0x0fffffff),(0xffffffff,32,0),(0xffffffff,3,0x1fffffff)]
  ...
  ++ testOp Int64 "shl" prim__shl_Int64
       [(0,63,0),(1,1,2),(1,4,16),(1,63,-0x8000000000000000),(1,64,0),(-1,63,-0x8000000000000000)]
  ++ testOp Int64 "shr" prim__shr_Int64
       [(0,63,0),(1,1,0),(-0x8000000000000000,1,-0x4000000000000000),(0x7fffffffffffffff,3,0x0fffffffffffffff),(-0x8000000000000000,64,-1),(-1,3,-1)]
  ...
  ++ testOp Bits64 "shl" prim__shl_Bits64
       [(0,63,0),(1,1,2),(1,4,16),(1,63,0x8000000000000000),(1,64,0),(0xffffffffffffffff,63,0x8000000000000000)]
  ++ testOp Bits64 "shr" prim__shr_Bits64
       [(0,63,0),(1,1,0),(0xffffffffffffffff,1,0x7fffffffffffffff),(0x7fffffffffffffff,3,0x0fffffffffffffff),(0xffffffffffffffff,64,0),(0xffffffffffffffff,3,0x1fffffffffffffff)]
