...
# Add nixpkg identifier here before using it elsewere
# Please keep this in sync with `shell.nix`
, chez
, clang
, gmp
, gambit
...
stdenv.mkDerivation rec {
  ...
  # Exectutables
  nativeBuildInputs = [ chez clang idris2 makeWrapper ];
  # Libraries
  buildInputs = [ gmp ];
  ...
  checkInputs = [ chez gambit nodejs racket ];
  checkTarget = "test";
