...
envs = [
    ...
    MkEnvDesc "IDRIS2_NO_GMP"        "RefC backend: disable GMP (use int64_t for Integer); equivalent to the no-gmp directive.",
    MkEnvDesc "IDRIS2_NO_FFI"        "RefC backend: omit -lffi from the link; equivalent to the no-ffi directive.",
    MkEnvDesc "IDRIS2_NO_THREADS"    "RefC backend: disable pthreads (stub out threads/mutex/condvar); equivalent to the no-threads directive.",
    MkEnvDesc "IDRIS2_NO_STDIO"      "RefC backend: exclude stdio (fprintf/vsnprintf) from the runtime; equivalent to the no-stdio directive. Implied for bare-metal targets.",
    MkEnvDesc "IDRIS2_NO_CLOCK"      "RefC backend: stub time()/clock() to return 0; equivalent to the no-clock directive. Implied for bare-metal targets.",
    MkEnvDesc "IDRIS2_NO_SUPPORT_LIB" "RefC backend: skip linking libidris2_support.a; equivalent to the no-support-lib directive. Implied for bare-metal targets.",
    MkEnvDesc "IDRIS2_REFC_LIB_DIR" "RefC backend: directory containing libidris2_refc.a (overrides the installed data directory, useful for WASM/cross builds).",
    MkEnvDesc "IDRIS2_REFC_SUPPORT_LIB" "RefC backend: path to libidris2_support.a (overrides the installed library, useful for WASM/cross builds).",
