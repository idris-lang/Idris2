...
parserCommandsForHelp =
  ...
  , nameArgCmd (ParseIdentCmd "di") (DebugInfo False) "Show debugging information for a name"
  , nameArgCmd (ParseIdentCmd "di2") (DebugInfo True) "Show debugging information for a name (experimental)"
