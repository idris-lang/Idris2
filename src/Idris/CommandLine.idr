...
data CLOpt
  ...
  FindIPKG |
  Timing |
   ||| Changes the output bytecode to include performance information
  RuntimePerf |
  DebugElabCheck |
  BlodwenPaths
...
options = [MkOpt ["--check", "-c"] [] [CheckOnly]
           ...
           MkOpt ["--runtime-performance"] [] [RuntimePerf]
              (Just "Add runtime performance information to generated bytecode"),
