...
knownTopics = [
    ...
    ("import", Nothing),
    ("import.file", Nothing),
    ("import.directive", Just "Handling import directives"),
    ("import.directive.hiding", Just "Handling `hiding` clauses in import directives"),
    ("import.directive.renaming", Just "Handling `renaming` clauses in import directives"),
    ("import.directive.using", Just "Handling `using` clauses in import directives"),
