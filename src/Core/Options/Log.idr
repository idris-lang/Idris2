...
knownTopics = [
    ...
    ("ide-mode.highlight", Just "Semantic highlighting of source code"),
    ("ide-mode.highlight.alias", Just "Semantic highlighting of aliased locations wrt to their reference"),
