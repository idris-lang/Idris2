...
(define (blodwen-bits-shl-fast x y bits) (define mask (sub1 (arithmetic-shift 1 bits))) (bitwise-and (if (and (fixnum? x) (fixnum? y)) (fxlshift x y) (arithmetic-shift x y)) mask))
